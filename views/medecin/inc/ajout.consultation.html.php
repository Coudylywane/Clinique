        ...
        <div class=" mt-3">
            <form action="" method="post">
                ...
                <div class="input-group ml-5">
                  <select class="form-control" name="medicament" id="">
                    <option value="0">Entrer un medicament</option>
                    <?php foreach ($medicaments as  $medicament):?>
                        <option value="<?=$medicament['id_medicament']?>"><?= $medicament['nom_medicament']?></option>
                    <?php endforeach?>
                    </select>                    
                    <input type="text" aria-label="Last name" class="form-control" style="margin-right: 30%;">
